    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (file.size > MAX_SIZE_MB * 1024 * 1024) {
                toast.info(`File is large (${(file.size / 1024 / 1024).toFixed(1)}MB). Compressing...`)
            ...
            const result = await createMeeting(filePath, title || file.name)
        ...
        <div className="flex flex-col gap-6 max-w-2xl mx-auto w-full">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Upload an audio recording to transcribe and analyze.</CardDescription>
                </CardHeader>
