...
export function UsageView({ embedded = false }: UsageViewProps) {
    ...
    return (
        <div className={`flex flex-col ${embedded ? 'h-full' : 'h-[calc(100vh-64px)] overflow-hidden bg-background'} text-foreground animate-in fade-in duration-300`}>
            <div className={`flex-1 ${embedded ? '' : 'overflow-y-auto custom-scrollbar p-6 lg:p-8'}`}>
                <div className={`${embedded ? 'max-w-full' : 'max-w-[1400px] mx-auto'} space-y-8`}>
                    ...
                    {embedded && (
                        <div className="flex items-center justify-between">
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-muted-foreground">Track your Groq API consumption</p>
                            </div>
